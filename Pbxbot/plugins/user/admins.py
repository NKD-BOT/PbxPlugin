...
HelpMenu("admin").add(
    "promote", "<𝗎𝗌𝖾𝗋𝗇𝖺𝗆𝖾/𝗂𝖽/reply> <𝗍𝗂𝗍𝗅𝖾>", "Promote a user to admin.", "promote @bot_nkd Badmunda"
).add(
    "demote", "<username/id/reply>", "Demote a user from admin.", "demote @bot_nkd"
).add(
    "ban", "<username/id/reply> <reason>", "Ban a user from the group.", "ban @bot_nkd"
).add(
    "unban", "<username/id/reply>", "Unban a user from the group.", "unban @bot_nkd"
).add(
    "kick", "<username/id/reply> <reason>", "Kick a user from the group.", "kick @bot_nkd"
).add(
    "mute", "<username/id/reply> <reason>", "Mute a user in the group", "mute @bot_nkd"
).add(
    "unmute", "<username/id/reply>", "Unmute a user in the group.", "unmute @bot_nkd"
).add(
